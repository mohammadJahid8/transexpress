  ...
  return (
    <form className='space-y-8'>
      <h2 className='text-xl font-semibold text-left'>
        Formulario Apertura CASILLERO EMPRESARIAL
      </h2>
      ...
      <div className='flex flex-col gap-4'>
        <h3 className='font-semibold text-left'>DATOS DE LA EMPRESA</h3>
        <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
          <Input type='text' placeholder='NOMBRE EMPRESA' />
          <Input type='text' placeholder='RTN EMPRESA' />
        </div>
        <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
          <Input type='email' placeholder='EMAIL EMPRESA' />
          <Input type='tel' placeholder='TEL. EMPRESA' />
        </div>
        <Input type='text' placeholder='DIRECCIÓN DE EMPRESA' />
        <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
          <Select>
            <SelectTrigger className=''>
      ...
      <div className='flex flex-col gap-4'>
        <h3 className='font-semibold text-left'>
          PERSONAS AUTORIZADAS RETIRAR CARGA
        </h3>
        <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
          <Input
            type='text'
            placeholder='NOMBRE APELLIDO PERSONA ENCARGADA No.1'
          />
          <Input type='text' placeholder='No. CÉDULA PERSONA ENCARGADA No.1' />
          <Input
            type='text'
            placeholder='NOMBRE APELLIDO PERSONA ENCARGADA No.2'
          />
          <Input type='text' placeholder='No. CÉDULA PERSONA ENCARGADA No.2' />
        </div>
      </div>
      <div className='flex flex-col gap-4'>
        <h3 className='font-semibold text-left'>
      ...
      <div className='flex flex-col gap-4'>
        ...
        <p className='text-sm text-gray-500'>
          <span className='font-semibold'>ENVÍO DE REGISTRO.</span> Acepto los
          términos y condiciones del contrato de Servicios de TransExpress para
          el servicio de Casillero Personal. Debes seleccionar botón aceptando
          los términos descritos. Términos y Condiciones
        </p>

        <ImageUpload description='Puedes subir hasta 5 archivos.' />

        <div className='flex flex-col gap-4'>
          <p className='text-sm text-gray-500'>
            <span className='font-semibold'>
              SUBIR DOCUMENTOS: Cédula y RTN del Representante Legal - RTN de La
              Sociedad - Escritura Constitución - Poder de Administración
            </span>{' '}
            Requerido Subir tus Documentos, Máximo 5 Archivos en JPG o PDF -
            Máximo de todos los archivos, 5 Megabytes
          </p>
          <Captcha onChange={() => {}} />
        </div>
      </div>
      <Button type='submit' className='w-full bg-blue-500 text-white'>
        ENVIAR SOLICITUD DE CASILLERO EMPRESARIAL
      </Button>
    </form>
  );
};

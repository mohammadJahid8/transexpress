    ...
    <>
      <div className='bg-[url("/calculator-bg.png")] bg-cover bg-center bg-no-repeat w-full h-64 flex items-center'>
        <div className='container mx-auto px-4 lg:px-32'>
          <h1 className='text-[#444444] text-[44px] font-bold'>ALERTS</h1>
        </div>
      </div>
        ...
        <form className='space-y-6'>
          ...
          <div>
            ...
            <p className='text-sm text-gray-500 mt-1'>
              Ingresa tu número de casillero completo y evita que tu alerta no
              se coloque. Ej HN17X0000N, SPS0000, TGU0000
            </p>
          </div>
          <div>
